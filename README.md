...
This contract is a raffle contract that allow `player` to join a raffle/lottery, then with the implementation of `Chainlink VRF` and `Chainlink Automation` it will pick a random winner.
